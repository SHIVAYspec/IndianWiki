...
function ComputerScienceIndex({ contents, additionalContents }: {
...
export function ComputerScienceRouter(): RouteObject {
    return {
        path: "computerscience",
        children: [
            {
                index: true,
                element: <ComputerScienceIndex additionalContents={additionalContents.map((e) => ({
                    name: e.name,
                    link: e.routes.path ?? "",
                }))} contents={contents} />,
            },
